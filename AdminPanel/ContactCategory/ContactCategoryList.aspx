            ...
            <asp:GridView ID="gvContactCategory" AutoGenerateColumns="false" CssClass="table table-hover" runat="server" OnRowCommand="gvContactCategory_RowCommand" CellPadding="4" ForeColor="#333333" GridLines="None">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Edit">
                        <ItemTemplate>
                            <asp:HyperLink runat="server" ID="btnEdit" Text="Edit" NavigateUrl='<%# "~/AdminPanel/ContactCategory/Edit/" + EncryptDecrypt.Base64Encode(Eval("ContactCategoryID").ToString().Trim()) %>' CssClass=" btn btn-info"/>
                        </ItemTemplate>
                    </asp:TemplateField>
