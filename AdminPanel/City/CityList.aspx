            ...
            <div>
                <asp:GridView ID="gvCity" AutoGenerateColumns="false" CssClass="table table-hover"  runat="server" OnRowCommand="gvCity_RowCommand" CellPadding="4" ForeColor="#333333" GridLines="None">
                    ...
                    <asp:TemplateField HeaderText="Edit">
                        <ItemTemplate>
                            <asp:HyperLink runat="server" ID="btnEdit" Text="Edit" NavigateUrl='<%# "/AdminPanel/City/Edit/" + EncryptDecrypt.Base64Encode(Eval("CityID").ToString().Trim()) %>' CssClass=" btn btn-info"/>
                        </ItemTemplate>
                    </asp:TemplateField>
